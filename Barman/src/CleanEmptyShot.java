...
public class CleanEmptyShot extends Method{
    ...
    public CleanEmptyShot(Shot shot,Hand handA, Beverage beverage,Hand handB){

        List<String> parameters = List.of(shot.getName(), handA.getName(),
                beverage.getName(), handB.getName());

        List<String> preconditions = new ArrayList<>();
        preconditions.addAll(List.of("empty", shot.getName(), beverage.getName()));
        ...
        super("CleanEmptyShot", parameters, preconditions, subtasks, taskToDecompose);
