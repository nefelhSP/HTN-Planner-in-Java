...
/**
 * MakeCocktailNull class that implements the Method interface.
 * It represents the method: MakeCocktailNull
 */
public class MakeCocktailNull extends Method {
    ...
    /**
     * Initializes the MakeCocktailNull method with the given shaker, cocktail, and decomposed task.
