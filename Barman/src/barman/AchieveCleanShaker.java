...
public class AchieveCleanShaker extends Task {
    ...
    protected void generateMethods() {
        ...
        List<Cocktail> allCocktails = helper.getAllItems(Cocktail.class);

        // The method CleanShakerNull requires just a shaker
        ...
        // The method CleanFullShaker requires two hands, two levels, a shaker and a cocktail
        // Generating all possible combinations and making sure I do not have the same two hands
        for (Hand hand1 : allHands) {
            for (Hand hand2 : allHands) {
                if (hand1.equals(hand2))
                    continue;
