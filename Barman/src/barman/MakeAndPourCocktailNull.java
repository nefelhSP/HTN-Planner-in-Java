...
/**
 * MakeAndPourCocktailNull class that implements the Method interface.
 * It represents the method: MakeAndPourCocktailNull
 */
public class MakeAndPourCocktailNull extends Method {
    ...
    /**
     * Initializes the MakeAndPourCocktailNull method with the given shot, cocktail, and decomposed task.
