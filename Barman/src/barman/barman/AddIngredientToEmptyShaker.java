...
/**
 * AddIngredientToEmptyShaker class that implements the Method interface.
 * It represents the method: AddIngredientToEmptyShaker
 */
public class AddIngredientToEmptyShaker extends Method {
        ...
        /**
         * Constructor for AddIngredientToEmptyShaker
         * 
         ...
         */
        public AddIngredientToEmptyShaker(Shaker shaker, Ingredient ingredient, Level levelA, Level levelB, Shot shot,
                ...
                List<Task> subtasks = List.of(
                                ...
                                new pour_shot_to_clean_shaker(shot, ingredient, shaker, otherHand, levelA, levelB));

                super("AddIngredientToEmptyShaker", parameters, preconditions, subtasks, decomposedTask);
