...
/**
 * The pour_shot_to_used_shaker class is an action that pours a shot to a used
 * shaker.
 */
public class pour_shot_to_used_shaker extends Action {
    ...
    /**
     * Initializes the pour_shot_to_used_shaker action with the given shot,
     ...
     */
    public pour_shot_to_used_shaker(Shot shot, Ingredient ingredient, Shaker shaker, Hand hand, Level levelA,
            Level levelB) {
