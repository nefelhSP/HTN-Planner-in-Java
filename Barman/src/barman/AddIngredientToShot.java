...
public class AddIngredientToShot extends Method {
     ...
     */
    public AddIngredientToShot(Shot shot, Ingredient ingredient, Dispenser dispenser, Hand handA, Hand handB, Task decomposedTask) {
        ...
        //Error print for violating the 3rd precondition
