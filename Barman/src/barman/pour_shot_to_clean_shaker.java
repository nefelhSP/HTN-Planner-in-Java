...
/**
 * The pour_shot_to_clean_shaker class that implements the Action interface.
 * It represents the action: clean-pour_shot_to_clean_shaker
 */
public class pour_shot_to_clean_shaker extends Action {
    ...
    /**
     * Initializes the pour_shot_to_clean_shaker action with the given shot, ingredient, shaker, hand, levelA, levelB, and decomposed task.
