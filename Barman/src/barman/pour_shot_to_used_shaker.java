...
/**
 * The pour_shot_to_used_shaker class that implements the Action interface.
 * It represents the action: clean-pour_shot_to_used_shaker
 */
public class pour_shot_to_used_shaker extends Action {
    ...
    /**
     * Initializes the pour_shot_to_used_shaker action with the given shot, ingredient, shaker, hand, levelA, levelB, and decomposed task.
     ...
     */
    public pour_shot_to_used_shaker(Shot shot, Ingredient ingredient, Shaker shaker, Hand hand, Level levelA, Level levelB) {
        ...
        super("pour-shot-to-used-shaker", parameters, preconditions, effects);
        this.shot = shot;
