...
/**
 * The empty_shaker class that implements the Action interface.
 * It represents the action: empty-shaker
 */
public class empty_shaker extends Action {
    ...
    /**
     * Initializes the empty_shaker action with the given hand, shaker, cocktail, levelA, and levelB.
    ...
    public empty_shaker(Hand hand, Shaker shaker, Cocktail cocktail, Level levelA, Level levelB) {
        ...
        List<String> parameters = List.of(hand.getName(), shaker.getName(), cocktail.getName(), levelA.getName(), levelB.getName());
