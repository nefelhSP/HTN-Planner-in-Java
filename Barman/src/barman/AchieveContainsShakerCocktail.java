...
public class AchieveContainsShakerCocktail extends Task {
    ...
    protected void generateMethods() {
        ...
        List<Ingredient> allIngredients = helper.getAllItems(Ingredient.class);

        // The method MakeCocktail requires two hands, two ingredients, a cocktail and a shaker
                ...
                for (Ingredient ingredient1 : allIngredients) {
                    for (Ingredient ingredient2 : allIngredients) {
                        if (ingredient1.equals(ingredient2))
                            continue; //Making sure I have two different ingredients

                        this.addMethod(new MakeCocktail(shaker, cocktail, ingredient2, hand1, hand2, ingredient1, this));
                    }
                }
            }
        }
