...
public class CleanFullShaker extends Method {
         ...
         */
        public CleanFullShaker(Shaker shaker, Level levelA, Cocktail cocktail, Hand handA, Hand handB, Level levelB, Task decomposedTask) {
                ...
                List<String> parameters = List.of(shaker.getName(), levelA.getName(), cocktail.getName(),
                                handA.getName(), handB.getName(), levelB.getName());
